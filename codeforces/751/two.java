...
public class two {
    ...
    static void solve() {
        ...
        int m = i();
        HashMap<Integer, ArrayList<combo>> q = new HashMap<>();
        ...
        for (int i = 0; i < m; i++) {
            ...
            if(!q.containsKey(k)){
                q.put(k, new ArrayList<>());
            }
            q.get(k).add(new combo(i,x-1));
        }
    ...
    public static long[] readArrayL(long n) {
