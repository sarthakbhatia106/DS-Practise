...
public class three {
    ...
    private static void fillSet(String str, int i, String ans, HashSet<String> set) {
        if(i==str.length()){
            set.add(ans);
            return;
        }
        if(str.charAt(i)=='0' || str.charAt(i)=='1'){
            fillSet(str,i+1,ans+str.charAt(i),set);
        }else{
            fillSet(str,i+1,ans+'1',set);
            fillSet(str,i+1,ans+'0',set);
        }
    }
