...
public class one {
    ...
    static void solve() {
        ...
        sb.append(Math.max(a > b ? 0 : Math.abs(a - b) + 1, a > c ? 0 : Math.abs(a - c) + 1) + " ");
        sb.append(Math.max(b > a ? 0 : Math.abs(a - b) + 1, b > c ? 0 : Math.abs(b - c) + 1) + " ");
        sb.append(Math.max(c > a ? 0 : Math.abs(a - c) + 1, c > b ? 0 : Math.abs(b - c) + 1) + "\n");
