...
public class treeFromPreAndPost {
    ...
    public static Node constructFromPrePost(int[] pre, int[] post) {
        ...
        return solve1(pre,post,map,0,pre.length-1,0,post.length-1);   
    }

    public static Node solve1(int[] pre,int []post, HashMap<Integer, Integer> map, int ps, int pe,int pos,int poe) {
        ...
        n.left=solve1(pre, post, map, ps+1, ps+total, pos, idx);
        n.right=solve1(pre,post,map,ps+total+1,pe,idx+1,poe-1);
