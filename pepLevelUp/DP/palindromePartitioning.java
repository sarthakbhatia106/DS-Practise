...
public class palindromePartitioning {
    ...
    static void solve() {
        ...
        sb.append(minCutsMoreComplexity(s,isPalindrome)+"\n");
        sb.append(minCutsOptimised(s,isPalindrome)+"\n");
    }
    private static int minCutsOptimised(String s, boolean[][] isPalindrome) {
    ...
    private static int minCutsMoreComplexity(String s, boolean[][] isPalindrome) {
                ...
                if(gap==0){
                    ...
                    if(isPalindrome[left][right]){
                        ...
                        for(int k=left;k<right;k++){
                            min=Math.min(min,dp[left][k]+dp[k+1][right]+1);
                        }
                        dp[left][right]=min;
                    }
                }
    ...
    private static void isPalindrome(String s, boolean[][] isPalindrome) {
