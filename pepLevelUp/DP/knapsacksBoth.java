...
public class knapsacksBoth {
    ...
    static void solve() {
        ...
        // sb.append(knapSack(n, W, val, wt)+"\n");
        sb.append(fractionalKnapsack(W, arr, n) + "\n");
    ...
    static double fractionalKnapsack(int W, Item arr[], int n) {
        // Your code here
        Arrays.sort(arr, (a, b) -> Double.compare((1.0 * (b.value / b.weight)), (1.0 * (a.value / a.weight))));
        ...
        for (Item i : arr) {
            if (i.weight <= W) {
                ...
                ans = ans + W * (1.0 * (i.value / i.weight));
            }
        }
        return ans;
    }
