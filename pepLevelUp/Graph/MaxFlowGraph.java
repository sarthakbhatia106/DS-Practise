...
public class MaxFlowGraph {
    ...
    static void solve() {
        ...
        long ans=solve(n,m,graph);
        sb.append(ans+"\n");
    }

    static long solve(int N, int M, long [][]graph) { 
    ...
    public static boolean bfsQ(long [][]graph,int src,int dest,int []par){
